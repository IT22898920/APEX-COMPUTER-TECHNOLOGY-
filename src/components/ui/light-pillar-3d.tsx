...
function parseColor(color: string): THREE.Vector3 {
...
export default function LightPillar3D({
  topColor = '#5227FF',
  bottomColor = '#FF9FFC',
  intensity = 1.0,
  rotationSpeed = 0.3,
  ...
  useEffect(() => {
    ...
    const qualitySettings = {
      low: { pixelRatio: 0.5, iterations: 32, waveIterations: 2, stepMultiplier: 1.5 },
      medium: { pixelRatio: 0.75, iterations: 48, waveIterations: 3, stepMultiplier: 1.2 },
      high: { pixelRatio: 1.0, iterations: 64, waveIterations: 4, stepMultiplier: 1.0 }
    }
