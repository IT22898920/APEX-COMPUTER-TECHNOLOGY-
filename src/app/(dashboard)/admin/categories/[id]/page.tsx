...
import { updateCategory, getCategories, type Category } from '../actions'
...
export default function EditCategoryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      // Only show categories without parents as potential parents (except current category)
      setParentCategories(categories.filter(c => !c.parent_id && c.id !== id))
      setIsFetching(false)
    }
